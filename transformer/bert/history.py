...
class History(torch.nn.Module):
    ...
    def __init__(self, num_embeddings: int, embedding_dim: int, device=None, dtype=torch.float32):
        super().__init__()
        ...
        self.emb = torch.empty(num_embeddings, embedding_dim, device=device, dtype=dtype,
